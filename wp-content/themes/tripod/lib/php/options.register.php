...
/*    options::$fields['likes'][ 'icons' ]            = array(
    ...
    /*  check if woocommerce is installed*/    
    if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
        options::$fields[ 'woo_shop_layout' ][ 'hint' ] = options::$fields[ 'front_page_layout' ][ 'hint' ];
    ...
    options::$fields[ 'styling' ][ 'heart_color' ] = array(
        ...
        'type' => 'st--color-picker',
        'hint' => __( "Set the collor for heart/likes." , 'cosmotheme' )
    );
...
*/
    ...
    $gallery_type = array('sly' => 'Sly', 'clasic' => 'Clasic', 'folio' => 'Folio', 'image_flow' => 'Image Flow','mosaic' => __('Mosaic view','cosmotheme')); 
    options::$fields['blog_post']['gallery_type']         = array('type' => 'st--select' , 'value' => $gallery_type , 'label' => __( 'Select gallery type' , 'cosmotheme' ), 'action' => "act.select( '.gallery_type' , { 'sly':'.sly_slider_speed'  } , 'sh_' );" , 'iclasses' => 'gallery_type' );
