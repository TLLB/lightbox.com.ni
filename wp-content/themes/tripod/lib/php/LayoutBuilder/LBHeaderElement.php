...
class LBHeaderElement extends LBElement{
        ...
        if( 'image' == options::get_value( 'styling' , 'logo_type' ) ){
            ...
            <div class="align-<?php echo $this -> vertical_align; ?>">
                <a <?php echo $retina_size_class;?> href="<?php echo home_url();?>">
                    <img <?php echo $retina_size;?> src="<?php echo $this -> src;?>" alt="" />
                </a>
            </div>
            <?php
        }else{
    ...
    function render_frontend_menu_and_logo(){
        ...
        if( options::get_value( 'styling' , 'logo_type' ) == 'text' ) { 
            ...
            $logo_content = '<a href="'.home_url().'" class="hover"><h1>' . $blog_name . '</h1><span>'. get_bloginfo( 'description' ). '</span></a>';
    ...
    function render_frontend_menu($is_stiky = false){
        ...
        /*mobile menu*/    
?>
        <div id="small-device-nav<?php echo $prepend_id ?>" class="small-device-nav">
    ...
    function render_frontend_login(){ 
        ...
        if ( is_user_logged_in() ) { ?>
            <ul class="login-menu sf-menu">
                <li>
                    <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php echo $this -> my_account_label; ?>"><i class="icon-author"></i><?php echo $this -> my_account_label; ?></a>
                    <ul>
                        ...
                        <?php
                            ...
                            if (strlen(get_permalink(woocommerce_get_page_id('view_order') ))) {
                                echo $this -> get_menu_item( 'orders', esc_url( get_permalink(woocommerce_get_page_id('view_order') ) ), __( 'View Order' , 'cosmotheme' ), '' );
                            }
                            if (strlen(get_permalink(woocommerce_get_page_id('edit_address') ))) {
                                echo $this -> get_menu_item( 'edit-address', esc_url( get_permalink(woocommerce_get_page_id('edit_address') ) ), __( 'My address' , 'cosmotheme' ), '' );
                            }
                            if (strlen(get_permalink(woocommerce_get_page_id('change_password') ))) {
                                echo $this -> get_menu_item( 'change-password', esc_url( get_permalink(woocommerce_get_page_id('change_password') ) ), __( 'Change password' , 'cosmotheme' ), '' );
                            }
                            ...
                            if (strlen(get_permalink(woocommerce_get_page_id('logout') ))) {
        ...
        <?php } else { ?>
            ...
            <ul class="login-menu sf-menu">
                <li>
                    <a class="signin" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php echo $this -> login_label.'-'.$this -> register_label; ?>"><i class="icon-author"></i><span><?php echo $this -> login_label; ?></span> <span class="login-delimiter"></span> <span><?php echo $this -> register_label; ?></span></a>
                </li>
            </ul>
        <?php } 
        echo '</div>';
