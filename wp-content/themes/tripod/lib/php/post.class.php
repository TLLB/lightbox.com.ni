                ...
                <div class="<?php echo $header_class; ?>">
                    <header class="list-elem-header  <?php if(options::logic( 'blog_post' , 'disable_hover_effect' )) { echo 'simple-hover';} ?>">
                        <?php if( self::is_feat_enabled($post->ID) ){ ?>
                            <div class="featimg">
                                <?php echo '<a class="list-hover-link" href="'. get_permalink($post->ID) .'"></a>'; ?>
                                <?php
                                    if (has_post_thumbnail($post->ID)) {
                ...
                <div class="<?php echo $content_class; ?>">
                    <section class="list-elem-section <?php if(get_post_type( $post -> ID ) == 'gallery' && $list_view_thumbs_size == 'full_width_thumb') { echo 'gallery-full-thumb'; } ?>">
                        <ul class="entry-content-list">
                            <li class="entry-content-title"><h2><a href="<?php echo get_permalink($post->ID); ?>" title="<?php _e('Permalink to', 'cosmotheme'); ?> <?php echo $post->post_title; ?>" rel="bookmark"><?php echo $post->post_title; ?></a></h2></li>
                            <li class="entry-content-meta">
    ...
    ?>
        ...
        <div class="thumb-elem <?php echo $disable_hover_effect?>">
            ...
            <section class="thumb-elem-section <?php echo $no_img_class; ?>">
                <a href="<?php echo get_permalink($post->ID); ?>"  title="<?php _e('Permalink to', 'cosmotheme'); ?> <?php echo $post->post_title; ?>" rel="bookmark" class="thumb-hover-link"></a>
                <ul class="entry-content-list">
                    <li class="entry-content-title"><a href="<?php echo get_permalink($post->ID); ?>"><h2><?php echo $post->post_title; ?></h2></a></li>
    ...
    ?>
        <div class="masonry_elem <?php echo $container_width; ?> columns">
            <div class="thumb-elem  <?php echo $container_class; echo ' '. $disable_hover_effect; ?> large-mosaic-elem">
                ...
                <section class="thumb-elem-section <?php echo $no_img_class; ?>">
                    <a href="<?php echo get_permalink($post->ID); ?>" title="<?php _e('Permalink to', 'cosmotheme'); ?> <?php echo $post->post_title; ?>" rel="bookmark" class="mosaic-hover-link"></a>
                    <ul class="entry-content-list">
                        <li class="entry-content-title"><a href="<?php echo get_permalink($post->ID); ?>"><h2><?php echo $post->post_title; ?></h2></a></li>
                        <li class="entry-content-delimiter"></li>
                        <?php  
        ...
        <div data-id="id-<?php echo $post->ID; ?>" class="masonry_elem <?php echo $width.' '.$additiona_class; ?>">
            <div class="grid-elem <?php if(get_post_type($post -> ID) == 'product'){ ?>product-grid<?php }?>  <?php echo ' '.$disable_hover_effect; ?>">
                ...
                <header class="grid-elem-header">
                    ...
                    <div class="featimg">
                        <?php if (get_post_type($post -> ID) == 'product' && $product->is_on_sale()) : ?>
                            <?php echo apply_filters('woocommerce_sale_flash', '<span class="onsale">'.__( 'Sale!', 'woocommerce' ).'</span>', $post, $product); ?>
                        <?php endif; ?>
                        <a href="<?php echo get_permalink($post->ID); ?>" class="grid-hover-link"></a>
                        <?php
                        if (has_post_thumbnail($post->ID) && post::is_feat_enabled($post->ID) ) {
                ...
                <section class="grid-elem-section <?php echo  $no_img_class  ?>">
                    <ul class="entry-content-list">
                        <li class="entry-content-title"><h2><a href="<?php echo get_permalink($post->ID); ?>"><?php echo $post->post_title; ?></a></h2></li>
        ...
        static function get_post_gallery_slide($post_id, $size="gallery_format_slider"){
            ...
            <?php          
                foreach($attachments as $att_id => $attachment) {
                    ...
                    $img_caption = $attachment_info->post_excerpt;
            ...
            ?>            
                    <a href="<?php echo $thumbnail_url[0]; ?>">
                        <img src="<?php echo $thumbnail_src[0]; ?>" data-big="<?php echo $thumbnail_url[0]; ?>" data-title="<?php echo $img_title;?>" data-description="<?php echo $img_caption; ?>" alt="<?php echo $img_caption; ?>" />
                    </a> 
